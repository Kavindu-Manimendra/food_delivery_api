...
import org.foodapi.entity.FoodEntity;
import org.foodapi.repository.FoodRepository;
...
public class FoodServiceImpl implements FoodService {
    ...
    public FoodResponse readFood(String id) {
        FoodEntity existingFood = foodRepository.findById(id).orElseThrow(() -> new RuntimeException("Food with id " + id + " not found."));
